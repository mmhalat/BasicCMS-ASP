...
<body>
  ...
  <table width="983" border="0" align="center" cellpadding="0" cellspacing="0" cols="2" bgcolor="#FEFEFE">
    ...
    <tr>
      ...
      <td width="546" valign="top" background="images/bg.jpg" class="style4"><table width="541" height="336" border="0" cellpadding="0" cellspacing="0">
          <form action="gonder.asp" method="post" ><tr>
            <td width="114" height="22"><div align="left" class="style26">Adiniz Soyadiniz </div></td>
            <td width="4"><span class="style26">:</span></td>
            <td width="144"><input name="isim" type="text"></td>
            <td width="279">&nbsp;</td>
          </tr>
          <tr>
            <td height="10"><div align="left" class="style26">Konu</div></td>
            <td height="10"><span class="style26">:</span></td>
            <td height="10"><input name="baslik" type="text"></td>
            <td height="10">&nbsp;</td>
          </tr>
          <tr>
            <td height="10"><div align="left" class="style26">E-Mail Adresiniz </div></td>
            <td height="10"><span class="style26">:</span></td>
            <td height="10"><input  name="email" type="text"></td>
            <td height="10"> ( Lütfen Dogru Yazınız ) </td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="10" colspan="4"><div align="left" class="style26">Mesajiniz ( Reklam Vermek İstediğiniz Bölge ,) :</div></td>
            </tr>
          <tr>
            <td height="49" colspan="4"><div align="left" class="style26">
