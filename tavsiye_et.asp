...
<body>
  ...
  <table width="983" border="0" align="center" cellpadding="0" cellspacing="0" cols="2" bgcolor="#FEFEFE">
    ...
    <tr>
      ...
      <td width="546" valign="top" background="images/bg.jpg" class="style4"><table width="544" height="354" border="0" cellpadding="0" cellspacing="0">
          <form action="tavsiye_gonder.asp" method="post" ><tr>
            <td width="203" height="22"><div align="left" class="style26">Adiniz Soyadiniz </div></td>
            <td width="4"><span class="style26">:</span></td>
            <td width="144"><input name="isim" type="text"></td>
            <td width="193">&nbsp;</td>
          </tr>
          <tr>
            <td height="22"><div align="left" class="style26">Sizin E-Mail Adresiniz  </div></td>
            <td height="22"><span class="style26">:</span></td>
            <td height="22"><input name="k_email" type="text"></td>
            <td height="22">&nbsp;</td>
          </tr>
          <tr>
            <td height="22"><div align="left" class="style26">Göndereceginiz E-Mail Adresi  </div></td>
            <td height="22"><span class="style26">:</span></td>
            <td height="22"><input  name="g_email" type="text"></td>
            <td height="22">&nbsp;</td>
          </tr>
          <tr>
            <td height="10" colspan="4">
                <div align="left"><span class="style25"><span class="style26"></span></span> </div></td>
          </tr>
          <tr>
            <td height="10" colspan="4"><div align="left" class="style26">Sitemizi Neden Tavsiye Ediyorsunuz :</div></td>
            </tr>
          <tr>
            <td height="182" colspan="4"><div align="left" class="style26">
