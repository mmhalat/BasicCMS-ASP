...
sor = "Select * from lugat_kategoriler ORDER BY ilk_harf"
...
sql = "select * from lugat where kid=" & categoryid & ""
...
%> 
            <tr>
              ...
              <td width="412" height="15" align="center" bgcolor="#ffffff" class="style39"><div align="center"><a href="lugatalt.asp?kid=<%=yeniasp("kid")%>" ><%=yeniasp("kategori_adi")%></a></div></td>
<%
yeniasp.MoveNext
