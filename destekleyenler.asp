...
<body>
  ...
  <table width="983" border="0" align="center" cellpadding="0" cellspacing="0" cols="2" bgcolor="#FEFEFE">
    ...
    <tr>
      ...
      <div align="center">
        <table width="400" height="428" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="30" colspan="2"><p><img src="images/destek.gif" width="400" height="30" border="0"></p>              </td>
          </tr>
          <tr>
            <td width="38" rowspan="9"> &nbsp;&nbsp;<img src="images/destek_.gif" width="30" height="400" border="0"></td>
            <td width="362" height="43"><div align="left">
              <%set sdestek = Server.CreateObject("ADODB.RecordSet")
													SQL = "select * from sayfa_destekleyenler"
													sdestek.open SQL,baglanti,1,3%>
              <%=sdestek("link")%></div></td>
          </tr>
          <tr>
            <td height="50"><div align="left"><%=sdestek("link1")%></div></td>
          </tr>
          <tr>
            <td height="45"><div align="left"><%=sdestek("link2")%></div></td>
          </tr>
          <tr>
            <td height="52"><div align="left"><%=sdestek("link3")%></div></td>
          </tr>
          <tr>
            <td height="44"><div align="left"><%=sdestek("link4")%></div></td>
          </tr>
          <tr>
            <td height="45"><div align="left"><%=sdestek("link5")%></div></td>
          </tr>
          <tr>
            <td height="50"><div align="left"><%=sdestek("link6")%></div></td>
          </tr>
          <tr>
            <td height="45"><div align="left"><%=sdestek("link7")%></div></td>
          </tr>
          <tr>
            <td height="16"><div align="left"><%=sdestek("link8")%></div></td>
          </tr>
        </table>
