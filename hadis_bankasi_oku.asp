...
<body>
  ...
  <table width="983" border="0" align="center" cellpadding="0" cellspacing="0" cols="2" bgcolor="#FEFEFE">
    ...
    <tr>
	  ...
	  <!--#include file="include_file/hbanka_db.asp"-->
	  <%
...
sql = " Select * from hadis where id=" & id
...
<table width="505" height="96" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#BEC9DB" id="Table_01">
  ...
  <tr bgcolor="#F1F1F1">  
    <td height="24" colspan="2"><div align="left"><span class="style3"><strong>
        <%=left(ekle("ac"),2300) %> &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; <strong>&nbsp;&nbsp; &nbsp;</strong><strong>&nbsp;&nbsp; &nbsp;</strong><strong>&nbsp;&nbsp; &nbsp;</strong><strong>&nbsp;&nbsp; &nbsp;</strong><strong>&nbsp;&nbsp; </strong><strong><strong>&nbsp;</strong><strong>&nbsp;&nbsp; </strong></strong><strong>(</strong></strong><strong><a href="hadis_html_oku.asp?id=<%=ekle("id")%>">Devamını) Geniş Sayfada Açmak İçin Tıklayın </a></strong></span></div></td>  
  </tr>  
  <tr bgcolor="#F1F1F1">  
    <td height="24" colspan="2"><div align="left"><span class="style3"><strong>
...
action="hadis_bankasi_kaydet.asp">
...
sql="select * from hadis_bankasi_yorumlar where yid="&yorum_id&" order by id desc;"
