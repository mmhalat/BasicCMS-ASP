...
<body>
  ...
  <table width="983" border="0" align="center" cellpadding="0" cellspacing="0" cols="2" bgcolor="#FEFEFE">
    ...
    <tr>
	  ...
	  <table width="538" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#D1D1D1">
            <tr>
              <td width="33" bgcolor="#980C12" height="20"><b><font color="#FFFFFF">&nbsp; #</font></b></td>
              <td width="412" align="center" bgcolor="#980C12" height="20"><span class="style37"><font color="#FFFFFF">Kategori Adı</font></span></td>
            </tr></table>
<%
...
sql = "select * from hadis_bankasi where kid=" & categoryid & ""
say.open sql, kon, 1, 3
end function
%>
...
%>
            <table><tr>
              <td width="33" bgcolor="#ffffff" height="15"><img src="images/klasor.gif" width="33" height="22"></td>
              <td width="496" height="15" align="center" bgcolor="#ffffff" class="style26 style36"><div align="left"><a href="hadis_bankasialt.asp?kid=<%=yeniasp("kid")%>"><%=yeniasp("kategori_adi")%></a></div></td>
<%
yeniasp.MoveNext
next
%>
	     ...
	     <br>
		<br>        <p align="center">Sayfa :          
          <%
for y=1 to sayfa 
if git=y then
response.write y
else
response.write "<b> <a href=""hadis_bankasikat.asp?kid="&kid&"&git="&y&""">"&y&"</a></b>"
end if
next
%></td>
