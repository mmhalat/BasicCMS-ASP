...
<body>
  ...
  <table width="983" border="0" align="center" cellpadding="0" cellspacing="0" cols="2" bgcolor="#FEFEFE">
    ...
    <tr>
	  ...
	  <table><tr><td width="531">
	  <!--#include file="include_file/indirinclude.asp"-->
	  <META http-equiv=refresh 
content="1; URL=<%=yeniasp("url")%>">
      <div align="center"><IMG alt=bağlanıyor.... src="yukleniyor.gif" vspace=3 
border=0><BR>
          <FONT id=font>Sunucuya Bağlanıyor Lütfen Bekleyiniz...</FONT><br>
  Eğer indirme işlemi hala başlamadıysa Lütfen
  <A href="<%=yeniasp("url")%>">burayı 
  tıklayınız.<br>
  </A><A 
href="linkkirik.asp">Eğer 
    link çalışmıyorsa burayı tıklayarak bize bildiriniz. 
        </A>
    <br>
