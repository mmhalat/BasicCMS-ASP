...
sor = "Select * from akaid_kategoriler ORDER BY ilk_harf"
...
sql = "select * from akaid where kid=" & categoryid & ""
...
%> 
            <tr>
              ...
              <td width="412" align="center" bgcolor="#ffffff" height="15"><div align="left"><a href="akaidalt.asp?kid=<%=yeniasp("kid")%>" class="style26 style32"><%=yeniasp("kategori_adi")%></a></div></td>
<%
yeniasp.MoveNext
