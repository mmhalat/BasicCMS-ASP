...
sor = "Select * from islam_tarihi ORDER BY id DESC"
...
SQL_delete = "DELETE from islam_tarihi WHERE id="&id&""
...
%>
    <tr>
      ...
      <td width="108" bgcolor="#FFFFFF">
        <p align="center"><a href="ibankaduz.asp?id=<%=yeniasp("id")%>">Düzenle</a> <b>-</b> <a href="islam_yonet.asp?sil=delete&id=<%=yeniasp("id")%>">Sil</a></td>
    </tr>
<%yeniasp.movenext%>
<% next %>
  </table>
...
response.write "<b> <a href=""islam_yonet.asp?git="&y&""">"&y&"</a></b>"
end if
next
%></td>
    </tr>
