...
<form action="reklam_kaydet.asp" method="post" name="3" class="style2" id="3">
  <table width="533" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td colspan="3"><div align="center" class="style13">REklamlar</div></td>
    </tr>
    <tr>
      <td width="48" class="style5"><span class="style5">Tarih</span></td>
      <td width="4" class="style5"><span class="style12 style5">:</span></td>
      <td><input name="tarih" type="text" id="site_baslik2" value="<%=reklamlar("tarih")%>"> 
    ...
    <tr>
      ...
      <td class="style5"><span class="style12  style8">:</span></td><td></b>
        ...
        <textarea name="link" cols="40" rows="10" id="link"><%=reklamlar("link")%></textarea>
        </span>
<td width="18">&nbsp;</td>
    </tr>
    <tr>
