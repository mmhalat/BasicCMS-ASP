...
sor = "Select * from fikih where id="&id
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="400">
    <tr>
      <td>
        <form method="POST" action="fbankaduz.asp?id=<%=yeniasp("id")%>&islem=duzenle">
...
<%
Set yeniasp = Server.CreateObject("ADODB.Recordset")
sora = "Select * from fikih_kategoriler ORDER BY ilk_harf"
