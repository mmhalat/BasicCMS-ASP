...
sor = "Select * from  ayetler where id="&id
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="400">
    <tr>
      <td>
        <form method="POST" action="ayet_duz.asp?id=<%=yeniasp("id")%>&islem=duzenle">
            ...
            <table border="0" cellpadding="0" width="400" bgcolor="#D1D1D1" cellspacing="1">
              <tr>
                ...
                <td width="250" height="25" bgcolor="#EAEAEA">&nbsp;
                  <textarea name="ayet_icerik" cols="30" rows="10" id="ayet_icerik"><%=yeniasp("ayet_icerik")%></textarea></td>
              </tr><tr>
