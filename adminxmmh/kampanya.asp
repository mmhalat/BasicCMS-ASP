...
<form action="kampanya_kaydet.asp" method="post" name="3" class="style2" id="3">
  <table width="533" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td colspan="3"><div align="center" class="style13">Ay&#305;n Kampanyas&#305;. </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="style5"><span class="style12  style8">:</span></td><td></b>
        ...
        <textarea name="kampanya" cols="40" rows="10" id="link"><%=destekleyenler("kampanya")%></textarea>
        </span>
<td width="18">&nbsp;</td>
    </tr>
    <tr>
