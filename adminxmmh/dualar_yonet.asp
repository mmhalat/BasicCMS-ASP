...
sor = "Select * from dualar ORDER BY id DESC"
...
SQL_delete = "DELETE from dualar WHERE id="&id&""
...
%>
    <tr>
      ...
      <td width="108" bgcolor="#FFFFFF">
        <p align="center"><a href="dbankaduz.asp?id=<%=yeniasp("id")%>">Düzenle</a> <b>-</b> <a href="dualar_yonet.asp?sil=delete&id=<%=yeniasp("id")%>">Sil</a></td>
    </tr>
<%yeniasp.movenext%>
<% next %>
  </table>
...
response.write "<b> <a href=""dualar_yonet.asp?git="&y&""">"&y&"</a></b>"
end if
next
%></td>
    </tr>
