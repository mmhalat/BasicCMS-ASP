...
sor = "Select * from akaid ORDER BY id DESC"
...
SQL_delete = "DELETE from akaid WHERE id="&id&""
...
%>
    <tr>
      ...
      <td width="108" bgcolor="#FFFFFF">
        <p align="center"><a href="abankaduz.asp?id=<%=yeniasp("id")%>">Düzenle</a> <b>-</b> <a href="akaid_yonet.asp?sil=delete&id=<%=yeniasp("id")%>">Sil</a></td>
    </tr>
<%yeniasp.movenext%>
<% next %>
  </table>
...
response.write "<b> <a href=""akaid_yonet.asp?git="&y&""">"&y&"</a></b>"
end if
next
%></td>
    </tr>
