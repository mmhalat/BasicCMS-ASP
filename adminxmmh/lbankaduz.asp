...
sor = "Select * from  lugat where id="&id
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="400">
    <tr>
      <td>
        <form method="POST" action="lbankaduz.asp?id=<%=yeniasp("id")%>&islem=duzenle">
...
<%
Set yeniasp = Server.CreateObject("ADODB.Recordset")
sora = "Select * from  lugat_kategoriler ORDER BY ilk_harf"
