...
sor = "Select * from hadisler ORDER BY id DESC"
...
SQL_delete = "DELETE from hadisler WHERE id="&id&""
mailsil.open SQL_delete,baglanti,1,3
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="1" width="479" bgcolor="#D1D1D1">
    <tr>
      <td width="368" bgcolor="#808080" height="20"><font color="#FFFFFF">İceriKKK</font></td>
...
%>
    <tr>
      <td width="368" bgcolor="#FFFFFF">&nbsp;<%=yeniasp("tarih")%></td>
      <td width="108" bgcolor="#FFFFFF">
        <p align="center"><a href="hadis_duz.asp?id=<%=yeniasp("id")%>">Düzenle</a> <b>-</b> <a href="hadis_yonet_blog.asp?sil=delete&id=<%=yeniasp("id")%>">Sil</a></td>
    </tr>
<%yeniasp.movenext%>
<% next %>
  </table>
...
response.write "<b> <a href=""hadis_yonet_blog.asp?git="&y&""">"&y&"</a></b>"
end if
next
%></td>
    </tr>
