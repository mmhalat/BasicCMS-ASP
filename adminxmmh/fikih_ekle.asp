...
sor = "Select * from fikih_kategoriler"
...
kid = Request("kid")
Set yeniasp = Server.CreateObject("ADODB.RecordSet")
SQL_delete = "delete from fikih_kategoriler where kid="&kid&""
...
<% Do while not yeniasp.eof %>
    <tr>
      ...
      <td width="100" bgcolor="#FFFFFF">
        ...
        <a href="fikih_ekle.asp?islem=sil&kid=<%=yeniasp("kid")%>"> Sil</a></font></font></td>
    </tr>
<%yeniasp.movenext%>
<%Loop%>
  </table>
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="300">
    <tr>
      <td>
        <form method="POST" action="fikih_ekle.asp?islem=ekle">
          <div align="center">
