...
sor = "Select * from kh ORDER BY id DESC"
...
SQL_delete = "DELETE from kh WHERE id="&id&""
...
%>
    <tr>
      <td width="368" bgcolor="#FFFFFF">&nbsp;<%=yeniasp("ad")%></td>
      <td width="108" bgcolor="#FFFFFF">
        <p align="center"><a href="kh_duz.asp?id=<%=yeniasp("id")%>">Düzenle</a> <b>-</b> <a href="kh_yonet.asp?sil=delete&id=<%=yeniasp("id")%>">Sil</a></td>
    </tr>
<%yeniasp.movenext%>
<% next %>
  </table>
...
response.write "<b> <a href=""kh_yonet.asp?git="&y&""">"&y&"</a></b>"
end if
next
%></td>
    </tr>
