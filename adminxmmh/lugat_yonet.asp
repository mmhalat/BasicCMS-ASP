...
sor = "Select * from lugat ORDER BY id DESC"
...
SQL_delete = "DELETE from lugat WHERE id="&id&""
...
%>
    <tr>
      ...
      <td width="108" bgcolor="#FFFFFF">
        <p align="center"><a href="lbankaduz.asp?id=<%=yeniasp("id")%>">Düzenle</a> <b>-</b> <a href="lugat_yonet.asp?sil=delete&id=<%=yeniasp("id")%>">Sil</a></td>
    </tr>
<%yeniasp.movenext%>
<% next %>
  </table>
...
response.write "<b> <a href=""lugat_yonet.asp?git="&y&""">"&y&"</a></b>"
end if
next
%></td>
    </tr>
