...
sor = "Select * from islam_tarihi_kategoriler"
...
kid = Request("kid")
Set yeniasp = Server.CreateObject("ADODB.RecordSet")
SQL_delete = "delete from islam_tarihi_kategoriler where kid="&kid&""
...
<% Do while not yeniasp.eof %>
    <tr>
      ...
      <td width="100" bgcolor="#FFFFFF">
        ...
        <a href="islam_ekle.asp?islem=sil&kid=<%=yeniasp("kid")%>"> Sil</a></font></font></td>
    </tr>
<%yeniasp.movenext%>
<%Loop%>
  </table>
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="300">
    <tr>
      <td>
        <form method="POST" action="islam_ekle.asp?islem=ekle">
          <div align="center">
...
Response.Write "<center><font face=verdana color=black size=1>Kategori eklendi...<br>Soldan Secim Yapın</font></center>"
Response.End
end sub
baglanti.close
%>
