...
sor = "Select * from hadis_bankasi_kategoriler"
...
kid = Request("kid")
Set yeniasp = Server.CreateObject("ADODB.RecordSet")
SQL_delete = "delete from hadis_bankasi_kategoriler where kid="&kid&""
  ...
  <table border="0" cellpadding="0" cellspacing="1" width="300" bgcolor="#D1D1D1">
    <tr>
      <td width="300" colspan="2" bgcolor="#808080" height="20">
        <p align="center"><font color="#FFFFFF"><b>Kategori İşlemleri</b></font></td>
    </tr>
    <tr>
      ...
      <td width="100" bgcolor="#EAEAEA" height="15">
        <p align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">İşlem</font></strong></td>
    </tr>
<% Do while not yeniasp.eof %>
    <tr>
      ...
      <td width="100" bgcolor="#FFFFFF">
        ...
        <a href="hadis_ekle.asp?islem=sil&kid=<%=yeniasp("kid")%>"> Sil</a></font></font></td>
    </tr>
<%yeniasp.movenext%>
<%Loop%>
  </table>
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="300">
    <tr>
      <td>
        <form method="POST" action="hadis_ekle.asp?islem=ekle">
          <div align="center">
...
Response.Write "<center><font face=verdana color=black size=1>Kategori eklendi...<br>Sagdan Secim Yapın.</font></center>"
Response.End
end sub
baglanti.close
%>
