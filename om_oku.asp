...
sql = " Select * from mesajlar where kimlik=" & id
ekle.open sql,baglan,1,3
ekle.update
%>

<table width="505" height="65" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#BEC9DB" id="Table_01">
  <tr bgcolor="#BEC9DB">  
    <td width="255" height="15" class="nav"><div align="center" class="style3 style1 style2 style25">
      <div align="left"><strong><span class="nav style42">
            <span class="style24">Konu:</span><%=ekle("konu") %>  
      </span></strong></div>
    </div></td>  
    <td width="256" class="nav style25"><span class="style24">Gonderen:</span><%=ekle("kimden")%></td>
  </tr>  
  <tr bgcolor="#F1F1F1">  
    <td height="24" colspan="2"><p><span class="style24">Mesaj:<br></span><span class="style3"><strong><%=ekle("mesaj") %>  
      </strong></span></p>      </td>  
  </tr>  
    <tr bgcolor="#F1F1F1">  
