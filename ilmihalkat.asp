...
sor = "Select * from ilmihal_kategoriler ORDER BY ilk_harf"
...
sql = "select * from ilmihal where kid=" & categoryid & ""
...
%>
	  <table width="540" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#D1D1D1">
            <tr>
              <td width="38" bgcolor="#980C12" height="20"><b><font color="#FFFFFF">&nbsp; #</font></b></td>
              <td width="484" align="center" bgcolor="#980C12" height="20"><span class="style34"><font color="#FFFFFF">Kategori Adı</font></span></td>
            </tr>
<%
While Not yeniasp.EOF
%> 
            <tr>
              <td width="38" bgcolor="#ffffff" height="15"><img src="images/klasor.gif" width="33" height="22"></td>
              <td width="484" height="15" align="center" bgcolor="#ffffff" class="style33"><div align="left" class="style37"><a href="ilmihalalt.asp?kid=<%=yeniasp("kid")%>" class="style33 style38"><%=yeniasp("kategori_adi")%></a></div></td>
<%
yeniasp.MoveNext
