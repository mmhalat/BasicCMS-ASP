...
sql = "select * from kh order by id"
...
yon=yon+1
  ...
  <tr> 
    <td width="422" height="20" bgcolor="#F1F1F1"><div align="left"><span class="Doviz"><span class="style44 style6"><strong> »</strong></span></span><span class="byazi"><a href="kh_oku.asp?id=<% =fikrars("id")%>">
        <% =fikrars("ad") %>
    </a></span></div></td>
...
<table width="505" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#BEC9DB" bgcolor="#F1F1F1">
  <tr> 
    <td width="492"><div align="center"> 
      <p><span class="style4">Her Sayfada</span><b class="orta"><span class="byazi"> <span class="style4">15</span> </span></b><span class="byazi"><span class="style4">Kayıttan Toplam</span></span><b class="orta"><span class="byazi"><span class="style4"> <%=topla%></span> </span></b><span class="byazi"><span class="style4">Kıssadan Hisses var</span>.</span> </p> 
