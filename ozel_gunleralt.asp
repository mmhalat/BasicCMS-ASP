  ...
  <table width="983" border="0" align="center" cellpadding="0" cellspacing="0" cols="2" bgcolor="#FEFEFE">
    ...
    <tr>
      ...
      <td width="546" valign="top" background="images/bg.jpg" class="style4"><table width="541" border="0" cellpadding="0" cellspacing="0" bordercolor="#990000">
		  ...
		  <!--#include file="include_file/obanka_db.asp"-->
	  <%
...
sor = "Select * from ozel_gunler WHERE kid=" & kid & ""
...
%>
    <tr>
      ...
      <td width="508" class="style26 style32"><div align="left"><b><a href="ozel_gunler_oku.asp?id=<%=yeniasp("id")%>"><%=yeniasp("isim")%></a></b></div></td>
    </tr>
<%yeniasp.movenext%>
<% next %>
  </table>
...
response.write "<b> <a href=""ozel_gunleralt.asp?kid="&kid&"&git="&y&""">"&y&"</a></b>"
end if
next
%>
<%kon.close
