...
sor = "Select * from islam_tarihi_kategoriler ORDER BY ilk_harf"
...
sql = "select * from islam_tarihi where kid=" & categoryid & ""
...
%> 
            <tr>
              ...
              <td width="412" align="center" bgcolor="#ffffff" height="15"><div align="left"><a href="islam_tarihialt.asp?kid=<%=yeniasp("kid")%>" class="style26 style36"><%=yeniasp("kategori_adi")%></a></div></td>
<%
yeniasp.MoveNext
