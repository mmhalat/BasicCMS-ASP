...
sor = "Select * from fikih WHERE kid=" & kid & ""
...
%>
    <tr>
      ...
      <td width="508" class="style26 style32"><div align="left"><b><a href="fikih_oku.asp?id=<%=yeniasp("id")%>"><%=yeniasp("isim")%></a></b></div></td>
    </tr>
<%yeniasp.movenext%>
<% next %>
  </table>
...
response.write "<b> <a href=""fikihalt.asp?kid="&kid&"&git="&y&""">"&y&"</a></b>"
end if
next
%><%kon.close
		set kon=nothing%></td>
