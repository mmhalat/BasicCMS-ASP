...
<body>
  ...
  <table width="983" border="0" align="center" cellpadding="0" cellspacing="0" cols="2" bgcolor="#FEFEFE">
    ...
    <tr>
	  ...
	  <!--#include file="include_file/dbanka_db.asp"-->
	  <%
...
sql = " Select * from dualar where id=" & id
...
<table width="505" height="96" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#BEC9DB" id="Table_01">
  ...
  <tr bgcolor="#F1F1F1">  
    <td height="24" colspan="2"><div align="left"><span class="style3"><strong>
        <%=left(ekle("ac"),2300) %> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="dualar_html_oku.asp?id=<%=ekle("id")%>">(Devamını) Geniş Sayfada Açmak İçin Tıklayın
...
sql="select * from dualar_yorumlar where yid="&yorum_id&" order by id desc;"
