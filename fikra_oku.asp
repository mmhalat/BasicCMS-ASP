...
<body>
  ...
  <table width="983" border="0" align="center" cellpadding="0" cellspacing="0" cols="2" bgcolor="#FEFEFE">
    ...
    <tr>
      <td width="204" background="images/bg.jpg" class="style4"><!--#include file="sol_menu.asp"--></td>
	  ...
	  <link href="css.css" type="text/css" rel="StyleSheet">      <div align="center"><img src="images/fikra.gif" width="525" height="31">      <br /> 
...
sql="select * from yorumlar where yid="&yorum_id&" order by id desc;"
...
function ValidateForm() {
	if (document.frm1.elements[0].value=="" || document.frm1.elements[1].value=="") {
		window.alert("Lütfen mesaj alanyny doldurunuz.")
