...
<table width="505" height="96" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#BEC9DB" id="Table_01">
  ...
  <tr bgcolor="#F1F1F1">  
    <td height="24" colspan="2"><div align="left"><span class="style3"><strong>
        <%=left(ekle("ac"),2300) %>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="ozel_html_oku.asp?id=<%=ekle("id")%>">(Devamını) Geniş Sayfada Açmak İçin Tıklayın
...
sql="select * from ozel_gunler_yorumlar where yid="&yorum_id&" order by id desc;"
