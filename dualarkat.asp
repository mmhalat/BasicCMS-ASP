...
sor = "Select * from dualar_kategoriler ORDER BY ilk_harf"
...
sql = "select * from dualar where kid=" & categoryid & ""
...
%>
	  <table width="538" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#D1D1D1">
            <tr>
              ...
              <td width="412" align="center" bgcolor="#980C12" height="20"><span class="style34"><font color="#FFFFFF">Kategori Adı</font></span></td>
            </tr>
<%
...
%> 
            <tr>
              ...
              <td width="412" align="center" bgcolor="#ffffff" height="15"><div align="left"><a href="dualaralt.asp?kid=<%=yeniasp("kid")%>" class="style26 style32"><%=yeniasp("kategori_adi")%></a></div></td>
<%
yeniasp.MoveNext
