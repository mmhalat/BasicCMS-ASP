<%
otomatik_onay = false 'False Admin Elle || True Otomatki Olarak
...
yonetici_sifresi = "admin.asp"
sozlesme_metni_sayfasi = "sozlesme_metni.txt" 'sozleme metni yolu
'veritabani ayarlari 
db_name = "../XlhGyAeRT_GfDsZrTyUoHlK_ggggggg_ZekFGyH/yeLDfRCdADGjh_MnJoA_HXXXqwEGhBB.mdb" ' veritabani yolu
'veritabani ayarlari bitis

'_________/!\ÖNEMLI______ BIRKALAMA_______
