...
sor = "Select * from dualar WHERE kid=" & kid & ""
...
%>
    <tr>
      ...
      <td width="508" class="style26 style32"><div align="left"><b><a href="dualar_oku.asp?id=<%=yeniasp("id")%>"><%=yeniasp("isim")%></a></b></div></td>
    </tr>
<%yeniasp.movenext%>
<% next %>
  </table>
...
response.write "<b> <a href=""dualaralt.asp?kid="&kid&"&git="&y&""">"&y&"</a></b>"
end if
next
%><%kon.close
		set kon=nothing%></td>
